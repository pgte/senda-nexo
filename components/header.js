    ...
    return (
      <Navbar.Header {...this.props}>
        <Navbar.Brand tabIndex='-1'>
          <a href='#'>
            <img src='/static/imgs/common/logo.png' alt='rubix' width='111' height='28' />
          </a>
        </Navbar.Brand>
      </Navbar.Header>
    );
...
class FlagMenu extends React.Component {
  ...
  render() {
    const flagIcon = (
      <img src={`/static/imgs/app/flags/flags/flat/32/${this.state.selectedFlag}.png`} width='32' height='32' />
    );
      ...
      return (
        <MenuItem key={name} eventKey={flag} active={this.state.selectedFlag === flag}>
          <Grid>
            <Row>
              <Col xs={2}>
                <img src={`/static/imgs/app/flags/flags/flat/32/${flag}.png`} alt={name} width='32' height='32' />
              </Col>
              <Col xs={10}>
      ...
      <NavDropdownHover noCaret eventKey={6} title={bullhornIcon} id='notifications-menu' className='header-menu collapse-left'>
          ...
          <Grid>
            <Row>
              <Col xs={2} className='avatar-container' collapseRight>
                <div><img src='/static/imgs/app/avatars/avatar22.png' width='40' height='40' alt='sarah_patchett' /></div>
        ...
        <MenuItem href='#'>
          <Grid>
            <Row>
              <Col xs={2} className='avatar-container' collapseRight>
                <img src='/static/imgs/app/avatars/avatar21.png' width='40' height='40' alt='john_young' />
              </Col>
              <Col xs={10} className='notification-container' collapseLeft collapseRight>
                <div className='time'>
        ...
        <MenuItem href='#'>
          <Grid>
            <Row>
              <Col xs={2} className='avatar-container' collapseRight>
                <div><img src='/static/imgs/app/github.png' width='40' height='40' alt='github' /></div>
                <div className='text-center'>
...
class HeaderNavigation extends React.Component {
  ...
  getPath(path) {
    var dir = this.props.location && this.props.location.pathname.search('rtl') !== -1 ? 'rtl' : 'ltr';
    path = `/${dir}/${path}`;
    return path;
  }
